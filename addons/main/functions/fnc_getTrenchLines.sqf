    ...
    if (_numConnections > 1) then {
        {
            ...
            private _objectsOverlap = _cornerLength - 2*_objectInnerLength;
            ...
            private _transitionOverlap  = _cornerLength - 2*_transitionInnerLength;
...
_nodes apply {
    ...
    } forEach [_mainLines, _cornerLines];
};
