...
_nodes apply {
    ...
    
    {
        ...
        private _t1 = [_start, _a1 + 90, _lowerWidth1] call FUNC(offset);
        private _t2 = [_midStart, _a1 + 90, _lowerWidth1] call FUNC(offset);
        private _t3 = [_midEnd, _a2 + 90, _lowerWidth2] call FUNC(offset);
        private _t4 = [_end, _a2 + 90, _lowerWidth2] call FUNC(offset);

        _terrainEdges pushBack [_t1, _t2];
        _terrainEdges pushBack [_t2, _t3];
        _terrainEdges pushBack [_t3, _t4];
        ...
        _polygonInner append [_t2, _t3];
        _polygonOuter append [_t2, _o2, _o3, _t3];
        _polygonTransition append [_t2, _o2, _b2, _b3, _o3, _t3];
        
        // private _midDir = (_p2 getDir _p3);
        // private _oPoints = if (_relAngle > 180) then {
        //     [
        //         [_p2, _a1 + 90, _objectsWidth] call FUNC(offset),
        //         [_p2, _midDir + 90, _objectsWidth] call FUNC(offset),
        //         [_p3, _midDir + 90, _objectsWidth] call FUNC(offset),
        //         [_p3, _a2 + 90, _objectsWidth] call FUNC(offset)
        //     ]
        // } else {
        //     [
        //         // [_p2, (_midDir + _a1)/2 + 90, _objectsWidth] call FUNC(offset),
        //         // [_p3, (_midDir + _a2)/2 + 90, _objectsWidth] call FUNC(offset)
        //         [_p2, _midDir + 90, _objectsWidth] call FUNC(offset),
        //         [_p3, _midDir + 90, _objectsWidth] call FUNC(offset)
        //     ]
        // };
        // _polygonOuter pushBack _p2;
        // _polygonOuter append _oPoints;
        // _polygonOuter pushBack _p3;
    } forEach _connections;
    // Close polygons
    {
        _x pushBack (_x#0);
    ...
    _node setVariable [QGVAR(terrainEdges), _terrainEdges];
